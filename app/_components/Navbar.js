...
function Navbar() {
  ...
  // optional: safe access to token fields
    ...
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      ...
      <div className="flex items-center gap-4">
        {!token ? (
          <>
            <Link href={"/login"}>
              <button className="w-24 md:w-32 rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
                Login
              </button>
            </Link>
            <Link href={"/signup"}>
          ...
          <div className="flex items-center gap-3 relative" ref={dropdownRef}>
            {/* Dashboard Button */}
            <Link href={"/dashboard"}>
              <button className="w-24 md:w-32 rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-700 dark:bg-white dark:text-black dark:hover:bg-gray-200">
                Dashboard
              </button>
            </Link>
            ...
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-700 transition-colors"
            >
              <div className="bg-black hover:border-y-gray-500 text-white rounded-full w-8 h-8 flex items-center justify-center">
              ...
              <ChevronDown className={`w-4 h-4 text-gray-400 dark:text-gray-300 transition-transform ${userDropdownOpen ? "rotate-180" : ""}`} />
            </button>

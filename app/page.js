...
import FeatureBentoGrid from "./_components/FeaturesBentoGrid";
    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          ...
          {"Start tracking your jobs instead of using excel"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        <motion.p
          ...
          className="relative z-10 mx-auto max-w-xl py-4 text-center text-lg font-normal text-neutral-600 dark:text-neutral-400">
            Tame your job search. Our intuitive platform replaces chaotic spreadsheets with a powerful tool designed 
            to organize your applications, track your progress, and help you land your next role.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
